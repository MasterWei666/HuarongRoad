...
public class MainActivity extends AppCompatActivity {
    ...
    float x1, x2, y1, y2;
    int Step;
    Uri uri = Uri.parse("https://baike.baidu.com/item/%E5%8D%8E%E5%AE%B9%E9%81%93/9528647?fr=aladdin");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent intent2 = new Intent(this,MusicServer.class);
    ...
    public void getBackgroundStory(View view) {
